...
* DATE: 2024-04-16
* COURSE ID:tx00db04
* DESCRIPTION:  ISR is triggered by Clock_1 (1Hz)
*               Calcuates the Average Value over the last second by divdiging
*               the sum by the sample rate (10_000)
*               Resets the sum and sets the flag for transmitting the data
*
********************************************************************************
